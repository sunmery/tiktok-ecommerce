...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xc6\x02\n" +
	"\x03Pay\x12.\n" +
	"\x06alipay\x18\x01 \x01(\v2\x16.kratos.api.Pay.AlipayR\x06alipay\x1a\x8e\x02\n" +
	"\x06Alipay\x12\x15\n" +
	...
	"\x0fapp_public_cert\x18\x06 \x01(\tR\rappPublicCert\x12(\n" +
	"\x10alipay_root_cert\x18\a \x01(\tR\x0ealipayRootCert\x12\x16\n" +
	"\x06secret\x18\b \x01(\tR\x06secret\"\x9b\x06\n" +
	"\x04Data\x125\n" +
	...
	"\bpassword\x18\a \x01(\tR\bpassword\"\x9c\x03\n" +
	"\rObservability\x125\n" +
	...
	"\tacl_token\x18\x02 \x01(\tR\baclTokenB\x1cZ\x1apayment/internal/conf;confb\x06proto3"
