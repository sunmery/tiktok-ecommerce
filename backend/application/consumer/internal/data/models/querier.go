...
type Querier interface {
	...
	//      currency, status, items
	CreateSubOrder(ctx context.Context, arg CreateSubOrderParams) (CreateSubOrderRow, error)
	//GetConsumerOrders
	//
	...
	GetConsumerOrdersWithSuborders(ctx context.Context, arg GetConsumerOrdersWithSubordersParams) ([]GetConsumerOrdersWithSubordersRow, error)
	//GetOrderByID
	//
	//  SELECT oo.id     AS order_id,
	//         os.id     AS sub_order_id,
