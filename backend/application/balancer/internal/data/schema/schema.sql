...
(
    ...
    type            VARCHAR(20) NOT NULL
        CHECK ( type IN ('ALIPAY', 'WECHAT', 'BANK_CARD')),
    is_default      BOOLEAN     NOT NULL DEFAULT FALSE,
    account_details JSONB       NOT NULL, -- 示例: {"account": "123@alipay.com", "real_name": "张三"}
...
-- CREATE TYPE merchant_payment_type AS ENUM ('ALIPAY', 'WECHAT', 'BANK_ACCOUNT');
CREATE TABLE balances.merchant_payment_methods
(
    id              BIGINT PRIMARY KEY,
    merchant_id     UUID        NOT NULL,
    type            VARCHAR(15) NOT NULL  -- 支付方式
        CHECK ( type IN ('ALIPAY', 'WECHAT', 'BANK_ACCOUNT')),
    is_default      BOOLEAN     NOT NULL DEFAULT FALSE,
...
(
    ...
    -- 支付方式快照
    payment_method_type VARCHAR(20)    NOT NULL,                              -- 支付方式: ALIPAY/WECHAT/BANK_CARD
