...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\x9b\x06\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05cache\x18\x02 \x01(\v2\x16.kratos.api.Data.CacheR\x05cache\x1a\x9a\x02\n" +
	"\x04Pool\x12\x1b\n" +
	"\tmax_conns\x18\x01 \x01(\x05R\bmaxConns\x12\x1b\n" +
	"\tmin_conns\x18\x02 \x01(\x05R\bminConns\x12E\n" +
	...
	"\bpassword\x18\a \x01(\tR\bpassword\"\xb0\x02\n" +
	"\x04SaaS\x122\n" +
	"\acasdoor\x18\x01 \x01(\v2\x18.kratos.api.SaaS.CasdoorR\acasdoor\x1a\xf3\x01\n" +
	"\aCasdoor\x127\n" +
	"\x06server\x18\x01 \x01(\v2\x1f.kratos.api.SaaS.Casdoor.ServerR\x06server\x1a\xae\x01\n" +
	"\x06Server\x12\x1a\n" +
	...
	"\vapplication\x18\x05 \x01(\tR\vapplication\"W\n" +
	"\x04Auth\x12&\n" +
	"\x03jwt\x18\x01 \x01(\v2\x14.kratos.api.Auth.JWTR\x03jwt\x1a'\n" +
	"\x03JWT\x12 \n" +
	"\vcertificate\x18\x01 \x01(\tR\vservice_key\"\x9c\x03\n" +
	"\rObservability\x125\n" +
	...
	"\tacl_token\x18\x02 \x01(\tR\baclTokenB$Z\"kratos-template/internal/conf;confb\x06proto3"
