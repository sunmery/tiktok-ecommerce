...
var (
	Name = constants.CommentServiceV1
	// Version 通过环境变量来替换
	Version           string
	flagconf          string
	configPath        string
...
func init() {
	...
	flag.StringVar(&configPath, "config_path", "ecommerce/comment/prod.yaml", "config center path, eg: -config_center organization/application/config.yaml")
