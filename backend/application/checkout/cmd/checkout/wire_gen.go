...
func wireApp(confServer *conf.Server, confData *conf.Data, consul *conf.Consul, observability *conf.Observability, logger log.Logger) (*kratos.App, func(), error) {
	...
	dataData, cleanup, err := data.NewData(client, logger, cartServiceClient, userServiceClient, orderServiceClient, paymentServiceClient, productServiceClient, consumerOrderClient)
	if err != nil {
		return nil, nil, err
	}
