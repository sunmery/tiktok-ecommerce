...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xe0\x02\n" +
	"\x04Data\x12,\n" +
	"\x05cache\x18\x01 \x01(\v2\x16.kratos.api.Data.CacheR\x05cache\x1a\xa9\x02\n" +
	"\x05Cache\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	...
	"\tacl_token\x18\x02 \x01(\tR\baclTokenB\x1dZ\x1bcheckout/internal/conf;confb\x06proto3"
