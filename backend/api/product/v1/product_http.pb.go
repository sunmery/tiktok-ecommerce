...
const OperationProductServiceUpdateInventory = "/ecommerce.product.v1.ProductService/UpdateInventory"
...
func RegisterProductServiceHTTPServer(s *http.Server, srv ProductServiceHTTPServer) {
	...
	r.PATCH("/v1/products/inventory", _ProductService_UpdateInventory0_HTTP_Handler(srv))
...
func _ProductService_UpdateInventory0_HTTP_Handler(srv ProductServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationProductServiceUpdateInventory)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *ProductServiceHTTPClientImpl) UpdateInventory(ctx context.Context, in *UpdateInventoryRequest, opts ...http.CallOption) (*UpdateInventoryReply, error) {
	var out UpdateInventoryReply
	pattern := "/v1/products/inventory"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationProductServiceUpdateInventory))
	opts = append(opts, http.PathTemplate(pattern))
