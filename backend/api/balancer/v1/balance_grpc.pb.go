...
const (
	...
	Balance_GetUserBalance_FullMethodName          = "/ecommerce.balance.v1.Balance/GetUserBalance"
	Balance_FreezeBalance_FullMethodName           = "/ecommerce.balance.v1.Balance/FreezeBalance"
	Balance_CancelFreeze_FullMethodName            = "/ecommerce.balance.v1.Balance/CancelFreeze"
...
type BalanceClient interface {
	...
	// 创建消费者账号指定币种的初始余额记录
	CreateConsumersBalance(ctx context.Context, in *CreateConsumersBalanceRequest, opts ...grpc.CallOption) (*CreateConsumersBalanceReply, error)
	// 用户余额充值
...
func (c *balanceClient) CreateConsumersBalance(ctx context.Context, in *CreateConsumersBalanceRequest, opts ...grpc.CallOption) (*CreateConsumersBalanceReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateConsumersBalanceReply)
	err := c.cc.Invoke(ctx, Balance_CreateConsumersBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBalanceServer) CreateConsumersBalance(context.Context, *CreateConsumersBalanceRequest) (*CreateConsumersBalanceReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateConsumersBalance not implemented")
}
...
func _Balance_CreateConsumersBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateConsumersBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BalanceServer).CreateConsumersBalance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Balance_CreateConsumersBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BalanceServer).CreateConsumersBalance(ctx, req.(*CreateConsumersBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Balance_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ecommerce.balance.v1.Balance",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateConsumersBalance",
			Handler:    _Balance_CreateConsumersBalance_Handler,
		},
		{
