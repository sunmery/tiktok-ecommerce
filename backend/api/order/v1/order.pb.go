...
type Order struct {
	...
	// 支付状态
	PaymentStatus PaymentStatus `protobuf:"varint,8,opt,name=payment_status,json=paymentStatus,proto3,enum=ecommerce.order.v1.PaymentStatus" json:"payment_status,omitempty"` // NOT_PAID/PROCESSING/PAID/FAILED
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListOrderReq struct {
	...
	DateRangeType string `protobuf:"bytes,5,opt,name=dateRangeType,proto3" json:"dateRangeType,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListOrderReq) GetStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *ListOrderReq) GetEndTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
func (x *ListOrderReq) GetDateRangeType() string {
	if x != nil {
...
type DateRangeStats struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TotalAmount   float64                `protobuf:"fixed64,1,opt,name=total_amount,json=totalAmount,proto3" json:"total_amount,omitempty"` // 时间段内总金额
	TotalOrders   uint32                 `protobuf:"varint,2,opt,name=total_orders,json=totalOrders,proto3" json:"total_orders,omitempty"`  // 时间段内订单总数
	Currency      string                 `protobuf:"bytes,3,opt,name=currency,proto3" json:"currency,omitempty"`                            // 主货币
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DateRangeStats) Reset() {
	*x = DateRangeStats{}
...
func (x *DateRangeStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DateRangeStats) ProtoMessage() {}

func (x *DateRangeStats) ProtoReflect() protoreflect.Message {
	mi := &file_v1_order_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DateRangeStats.ProtoReflect.Descriptor instead.
func (*DateRangeStats) Descriptor() ([]byte, []int) {
	return file_v1_order_proto_rawDescGZIP(), []int{6}
}

func (x *DateRangeStats) GetTotalAmount() float64 {
	if x != nil {
...
func (x *DateRangeStats) GetTotalOrders() uint32 {
	if x != nil {
...
func (x *DateRangeStats) GetCurrency() string {
	if x != nil {
		return x.Currency
	}
	return ""
...
type Pagination struct {
	...
	CurrentPage   uint32                 `protobuf:"varint,2,opt,name=current_page,json=currentPage,proto3" json:"current_page,omitempty"` // 当前页码
...
type ListOrderResp struct {
	...
	Stats         *DateRangeStats        `protobuf:"bytes,2,opt,name=stats,proto3" json:"stats,omitempty"` // 日期统计信息
...
func (x *ListOrderResp) GetStats() *DateRangeStats {
	if x != nil {
		return x.Stats
	}
	return nil
...
func (x *ListOrderResp) GetPagination() *Pagination {
	if x != nil {
		return x.Pagination
	}
	return nil
...
var file_v1_order_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x47, 0x0a, 0x0e,
	...
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0xf2, 0x02, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12,
	0x3e, 0x0a, 0x0b, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65,
	...
	0x72, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x08, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x72, 0x03, 0x98, 0x01, 0x03, 0x52,
	0x08, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12, 0x34, 0x0a, 0x07, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x65, 0x63, 0x6f,
	...
	0x12, 0x48, 0x0a, 0x0e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x65, 0x63, 0x6f, 0x6d, 0x6d,
	0x65, 0x72, 0x63, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61,
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0d, 0x70, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xd7, 0x01, 0x0a, 0x0c, 0x4c,
	0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12, 0x39, 0x0a, 0x0a, 0x73,
	...
	,
	...
	0x63, 0x79, 0x22, 0x66, 0x0a, 0x0a, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	...
	0x61, 0x6c, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a,
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x50, 0x61, 0x67, 0x65, 0x73, 0x22, 0xbc, 0x01, 0x0a, 0x0d, 0x4c,
	0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x31, 0x0a, 0x06,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x65,
	...
	0x38, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22,
	0x2e, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x72, 0x63, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x2e, 0x76, 0x31, 0x2e, 0x44, 0x61, 0x74, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x53, 0x74, 0x61,
	0x74, 0x73, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x12, 0x3e, 0x0a, 0x0a, 0x70, 0x61, 0x67,
	...
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2d, 0x0a, 0x10, 0x4d, 0x61, 0x72,
	0x6b, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x61, 0x69, 0x64, 0x52, 0x65, 0x71, 0x12, 0x19, 0x0a,
	...
	,
	...
	,
...
var file_v1_order_proto_goTypes = []any{
	...
	(*DateRangeStats)(nil),        // 7: ecommerce.order.v1.DateRangeStats
	(*Pagination)(nil),            // 8: ecommerce.order.v1.Pagination
	(*ListOrderResp)(nil),         // 9: ecommerce.order.v1.ListOrderResp
...
var file_v1_order_proto_depIdxs = []int32{
	...
	14, // 8: ecommerce.order.v1.ListOrderReq.start_time:type_name -> google.protobuf.Timestamp
	14, // 9: ecommerce.order.v1.ListOrderReq.end_time:type_name -> google.protobuf.Timestamp
	5,  // 10: ecommerce.order.v1.ListOrderResp.orders:type_name -> ecommerce.order.v1.Order
	7,  // 11: ecommerce.order.v1.ListOrderResp.stats:type_name -> ecommerce.order.v1.DateRangeStats
	8,  // 12: ecommerce.order.v1.ListOrderResp.pagination:type_name -> ecommerce.order.v1.Pagination
	1,  // 13: ecommerce.order.v1.OrderService.PlaceOrder:input_type -> ecommerce.order.v1.PlaceOrderReq
	6,  // 14: ecommerce.order.v1.OrderService.ListOrder:input_type -> ecommerce.order.v1.ListOrderReq
	10, // 15: ecommerce.order.v1.OrderService.MarkOrderPaid:input_type -> ecommerce.order.v1.MarkOrderPaidReq
	4,  // 16: ecommerce.order.v1.OrderService.PlaceOrder:output_type -> ecommerce.order.v1.PlaceOrderResp
	9,  // 17: ecommerce.order.v1.OrderService.ListOrder:output_type -> ecommerce.order.v1.ListOrderResp
